"""main.py - Runs the program and handles the visuals of the Password Vault."""
import json
import os
import getpass
from vault.password import generate_password
from vault.encrypt import encrypt, verify
from vault.account import view_accounts, add_account, delete_account
from vault.utils import divider

def save(user_data, username):
  """A function that saves users' data into a JSON dictionary."""
  users = {}
